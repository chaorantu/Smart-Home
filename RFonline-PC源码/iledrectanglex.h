#if !defined(AFX_ILEDRECTANGLEX_H__28DB3C6A_6C94_42E9_A4C0_8AD55FFE7FCE__INCLUDED_)
#define AFX_ILEDRECTANGLEX_H__28DB3C6A_6C94_42E9_A4C0_8AD55FFE7FCE__INCLUDED_
...
public:
	...
	void Lock();
	void Unlock();
	BOOL GetCenterLabelWordWrap();
	void SetCenterLabelWordWrap(BOOL bNewValue);
	long GetCenterLabelEndsMargin();
	void SetCenterLabelEndsMargin(long nNewValue);
	long GetCenterLabelAlignment();
	void SetCenterLabelAlignment(long nNewValue);
...
#endif // !defined(AFX_ILEDRECTANGLEX_H__28DB3C6A_6C94_42E9_A4C0_8AD55FFE7FCE__INCLUDED_)
